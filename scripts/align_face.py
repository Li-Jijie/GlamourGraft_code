...
parser.add_argument('-unaligned_dir', type=str, default='images/unaligned/', help='directory with unaligned images')
parser.add_argument('-output_dir', type=str, default='images/aligned/', help='output directory')
...
for im in Path(args.unaligned_dir).glob("*.*"):
    ...
    for i,face in enumerate(faces):
        if(args.output_size):
            ...
            face_tensor = torchvision.transforms.ToTensor()(face[0]).unsqueeze(0)
