...
def align_face(filepath,predictor,scale=1.0,offset=0.0):
    """
    :param filepath: str
    ...
    for lm in lms:
        ...
        # Transform.
        #quad_ = np.array([[0, 0], [0, img.size[1]], [img.size[0], img.size[1]], [img.size[0], 0]])
        ...
        # Save aligned image.
        imgs.append([img,c,qsize,angle_deg,lms])
    return imgs